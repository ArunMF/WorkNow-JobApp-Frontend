...
function AllCompanies() {
    ...
    return (
        <div>
            ...
            <div className='d-flex justify-content-center pt-3 pb-4 mx-5' style={{ borderBottom: '1px solid rgba(163, 163, 163, 0.308)' }}>
            ...
            <Row className='mx-4'>
                <Col className='col-4 border p-4 border-secondary rounded' id='filterCompanies'>
                            ...
                            <Row>
                                <Col className='col-9 d-flex'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-success'><b>4.3</b> <FaStar className='mb-1' /></p>
                                    </div>
                                </Col>
                                <Col className='col-3 d-flex justify-content-start'>
                                    <div className='me-4'>
                                        <h6 className='pt-2 text-center mb-0'>1.5L</h6>
                                        <p className='text-secondary text-center'><b>Reviews</b></p>
                                    </div>
                                    <div className='mx-4'>
                                        <h6 className='pt-2 text-center mb-0'>294</h6>
                                        <p className='text-secondary text-center'><b>Jobs</b></p>
                                    </div>
                                </Col>
                            </Row>
                            <Row className='mt-2'>
                                <Col className='col-4'>
                                    ...
                                    <p className='mb-0 text-secondary'>Information Technology Support Services</p>
                                </Col>
                                <Col className='col-1'></Col>
                                <Col className='col-4'>
                                    <h6 className='pt-2 mb-0'>Global company size</h6>
                                    <p className='mb-0 text-secondary'>10000+ Employees</p>
                                </Col>
                                <Col className='col-3'>
                                    <h6 className='pt-2 mb-0'>Locations</h6>
                                    <p className='text-secondary mb-0'>40 office locations</p>
                                </Col>
                            </Row>
                            {/* <Row className='mt-2'>
                                <div className='w-100'>
                    ...
                    <Card className='mb-3 px-2 shadow rounded' id='companyCard'>
                        <Card.Body>
                            <Row>
                                <Col className='col-9 d-flex'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-success'><b>4.8</b> <FaStar className='mb-1' /></p>
                                    </div>
                                </Col>
                                <Col className='col-3 d-flex justify-content-start'>
                                    <div className='me-4'>
                            ...
                            <Row className='mt-2' >
                                <Col className='col-4'>
                                    <h6 className='pt-2 mb-0'>Industry</h6>
                                    <p className='mb-0 text-secondary'>Software Development</p>
                                </Col>
                                <Col className='col-1'></Col>
                                <Col className='col-4'>
                                    <h6 className='pt-2 mb-0'>Global company size</h6>
                                    <p className='mb-0 text-secondary'>1000+ Employees</p>
                                </Col>
                                <Col className='col-3'>
                                    <h6 className='pt-2 mb-0'>Locations</h6>
                                    <p className='text-secondary mb-0'>28 office locations</p>
                                </Col>
                            </Row>
                            {/* <Row className='mt-2'>
                                <div className='w-100'>
