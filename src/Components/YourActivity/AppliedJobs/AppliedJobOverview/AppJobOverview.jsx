    ...
    return (
        <div className=' p-4'>
            <Row>
                ...
                {/* Apply button, etc. */}
                <Col className='h-50'>
                    <p className='mb-2 me-2' style={{ fontSize: "13px", float:"right" }}>Applied on <b className='text-success'>25 May 2024</b></p>
                    <div className='d-flex justify-content-end w-100'>
                        {/* <button className='btn btn-dark mx-1'><FaFileWaveform /> View application</button> */}
                        <button className='btn btn-success mx-1'><TiBookmark /> Remove</button>
                    </div>
                </Col>
            </Row>
